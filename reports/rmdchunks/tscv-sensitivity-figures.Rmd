...
```{r, include = FALSE}
# Supplementary Figure 5 - dengue forecasts for early warning at 4 and 8 week forecast horizons with no yearly random effect 
...
ggsave(filename = here(output_folder, "figure-S5.jpeg"), tscv_preds_sensitivity, width = 180, height = 120, units = "mm", bg="white", dpi = 300)
...
ggsave(filename = here(output_folder, "figure-S6.jpeg"), score_plot, width = 180, height = 180, units = "mm", bg="white", dpi = 300)
